"""EEGNet-StepType-WU1 — FROZEN warm-up submission candidate (2026-09-24).

Identical to eegnet_steptype.py except the solver name and the parameter
DEFAULTS, which are what Codabench runs: n_epochs=100, patience=20,
reference="none", seed=33 (best on full Dreyer overnight: 0.806 +/- 0.016
over 3 seeds). Do not edit; copy to a new WU<n> file for the next candidate.
