...
## State (updated 2026-09-25 18:30)

| Phase | Status | Where |
|---|---|---|
| 0 harness | ✅ done (caches, harness, overlays, watchdog, smoke) | LOG.md 2026-09-25 evening entry |
| 1 baselines | ⏳ running since 18:22, ETA ~19:35 | `logs/sealed_p1/` |
| 2 alignment | next | `scripts/sealed_p2.sh` (to write) |
| 3 pooling / personalisation | — | |
| 4 Scherer 3-class + Zyma | — | |
| 5 cross-dataset pre-training (overnight) | — | |
| 6 SEALED_RECIPE.md | — | |
