...
PRUNING_INTERVAL = 25   # Prune very frequently
TOP_N_TO_KEEP = 15      # Keep only top 15 results
                    ...
                    for use_bidirectional in bidirectional_list:
                        for l1_reg in l1_list:
                            for l2_reg in l2_list:
                                ...
                                print(f'Total rows: {len(rows)} (Iteration: {iteration_count})')
                                print('-' * 80)
...
if __name__ == "__main__":
    # Limit TF threads per process to avoid over-subscription and reduce memory
