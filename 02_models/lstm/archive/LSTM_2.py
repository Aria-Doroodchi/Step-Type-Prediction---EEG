...
# ============================================================================
# Function to run ONE participant (this is what we'll parallelize)
# ============================================================================
...
def run_single_participant(pid: str) -> pd.DataFrame:
    ...
    for cond in conditions:
        ...
        print(f'epochs data frame for {pid} {cond} created')
        ...
        print(f'PSD data frame for {pid} {cond} created')
        ...
        print(f"Removed {len(to_drop)} highly correlated columns from {pid} {cond}.")
    ...
    print(f"Finished participant {pid} with {participant_summary_df.shape[0]} rows.")
    return participant_summary_df

# ============================================================================
# Main: run participants in parallel and aggregate results
# ============================================================================

if __name__ == "__main__":
    # Optional: limit TF threads per process to avoid over-subscription
    # tf.config.threading.set_intra_op_parallelism_threads(1)
    # tf.config.threading.set_inter_op_parallelism_threads(1)

    max_workers = 4  # ← number of participants to run in parallel
